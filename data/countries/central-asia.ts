...
export const centralAsiaCountries: Country[] = [
  {
    ...
    faqs: [
      ...
      { q: "What warranty and spares support do you offer?", a: "Every machine carries a 12-month warranty on the laser source, drive and control system, with wear spares dispatched by the most reliable available air or rail route." },
