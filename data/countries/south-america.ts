...
export const southAmericaCountries: Country[] = [
  {
    ...
    shippingNote: "Sea freight from Kolkata or Haldia to Santos, Brazil's principal container port, typically routes around the Cape or via the Suez Canal with an indicative transit of 40–50 days. CIF delivery to Santos, Paranaguá or Itajaí is available alongside standard FOB Kolkata or Delhi terms.",
    ...
    faqs: [
      { q: "How do we request a price quotation for delivery to Brazil?", a: "Share your required cutting thickness, bed size and welding needs through our enquiry form and we will issue a US-dollar quotation with FOB Kolkata or Delhi and CIF options to Santos or your preferred port, along with confirmed lead time." },
      { q: "What Incoterms and shipping route do you use for Brazil?", a: "We ship FOB Kolkata or Delhi as standard with CIF available to Santos, Paranaguá or Itajaí. Transit is indicative and confirmed at the time of vessel booking, typically routing via the Cape or the Suez Canal." },
      ...
      { q: "What warranty and spares support do you offer?", a: "Every machine carries a 12-month warranty covering the laser source, drive and control system, with wear spares such as nozzles and lenses stocked for prompt air-freight dispatch to Brazilian addresses." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What warranty and spares support is available?", a: "Every machine carries a 12-month warranty on the laser source, drive and control system, and wear spares such as nozzles and lenses are stocked for prompt air-freight dispatch to Peru." },
