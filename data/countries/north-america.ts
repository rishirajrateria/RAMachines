...
export const northAmericaCountries: Country[] = [
  {
    ...
    faqs: [
      ...
      { q: "What warranty and spares support do you provide?", a: "Every machine carries a 12-month warranty on the laser source, drive and control system. Common wear spares such as nozzles, lenses and protective glass are stocked for fast air-freight dispatch to US addresses." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What warranty applies and how are spares supplied?", a: "Every machine carries a 12-month warranty covering the laser source, drive and control system. Wear spares such as nozzles and lenses are kept in stock for prompt air-freight dispatch to Canadian addresses." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What warranty and spares support is available in Mexico?", a: "Every machine carries a 12-month warranty on the laser source, drive and control system, and wear spares such as nozzles and lenses are stocked for rapid air-freight dispatch to Mexican addresses." },
