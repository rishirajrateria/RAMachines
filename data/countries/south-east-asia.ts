...
export const southEastAsiaCountries: Country[] = [
  {
    ...
    faqs: [
      ...
      { q: "What warranty and spares support do you provide?", a: "Every machine carries a 12-month warranty on the laser source, drive and control system, with wear spares such as nozzles and lenses stocked for prompt dispatch to Vietnamese addresses." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What warranty and spares support do you provide?", a: "Every machine carries a 12-month warranty on the laser source, drive and control system, with wear spares such as nozzles and lenses stocked for prompt air-freight dispatch to Jakarta." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How is installation and operator training carried out?", a: "We begin with remote video commissioning by our engineering team, followed by an on-site engineer visit for final calibration, safety checks and hands-on operator training." },
      { q: "What warranty and spares support do you provide?", a: "Every machine carries a 12-month warranty on the laser source, drive and control system, with wear spares such as nozzles and lenses stocked for prompt air-freight dispatch to Manila." },
