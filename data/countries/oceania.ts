...
export const oceaniaCountries: Country[] = [
  {
    ...
    shippingNote: "Sea freight from Kolkata or Haldia to Melbourne or Sydney typically transships via Singapore or Colombo with an indicative transit of 22–30 days. CIF delivery is available to your nearest Australian port alongside standard FOB Kolkata or Delhi terms.",
    ...
    faqs: [
      { q: "How do we request a quotation for delivery to Australia?", a: "Send your required cutting or welding specification through our enquiry form and we will issue a US-dollar quotation with FOB Kolkata or Delhi and CIF options to Melbourne, Sydney or Brisbane, along with confirmed lead time." },
      { q: "What shipping terms and transit time apply to Australia?", a: "We ship FOB Kolkata or Delhi as standard with CIF available to your nearest Australian port. Transit is indicatively 22 to 30 days, typically transshipping via Singapore or Colombo." },
      ...
      { q: "What warranty and spares support do you provide?", a: "Every machine carries a 12-month warranty on the laser source, drive and control system, with wear spares such as nozzles and lenses stocked for prompt air-freight dispatch to Australian addresses." },
